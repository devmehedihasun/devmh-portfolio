					...
					<div className="offCanvas__side-info mb-30">
						<div className="contact-list mb-30">
							...
							<div className="mb-3">
								...
								<p className="mb-0">01401585109</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Email</span>
								<p className="mb-0">mehedihasen2003@gmail.com</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Skype</span>
								<p className="mb-0">mehedihasen2003</p>
							</div>
							<div className="mb-3">
						...
						<div className="contact-list">
							...
							<div className="d-md-flex d-none gap-3">
								<Link href="https://web.facebook.com/mhxton7">
									<i className="ri-facebook-circle-fill fs-18" />
								</Link>
								<Link href="https://x.com/devmahedihasen">
									<i className="ri-twitter-x-fill fs-18" />
								</Link>
								<Link href="https://www.linkedin.com/in/mehedi-hasen-033907216">
									<i className="ri-linkedin-fill fs-18" />
								</Link>
								<Link href="https://github.com/devmehedihasun">

									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Web &amp; CMS Development</h6>
												<p className="fs-7 text-300 fw-regular">I have extensive experience in custom web development, crafting modern, responsive, and high-performing websites tailored to each client’s vision. I specialize in building with <span className="text-secondary-2">WordPress</span> and , <span className="text-secondary-2">Webflow CMS</span>, while also having hands-on experience with other popular platforms like Wix and Squarespace. My goal is to deliver visually engaging, user-friendly, and performance-optimized websites that ensure a seamless experience across all devices.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Custom WordPress Theme &amp; Plugin Development</h6>
												<p className="fs-7 text-300 fw-regular">With hands-on experience in custom theme and plugin development, I create tailored WordPress solutions that go beyond templates <span className="text-secondary-2">providing flexibility</span>, performance and complete control over design and functionality.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">API Integration & Advanced Functionality</h6>
												<p className="fs-7 text-300 fw-regular">CFrom integrating <span className="text-secondary-2">RESTful APIs</span> to building custom features, I ensure smooth data communication between systems and enhance website capabilities to meet unique business requirements.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">I optimize websites for <span className="text-secondary-2">speed, security, </span>, <span className="text-secondary-2">and scalability,</span>ensuring faster load times, better SEO performance, and an overall enhanced user experience.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">I build secure, scalable <span className="text-secondary-2">WooCommerce stores</span> that convert visitors into customers — integrating advanced payment gateways, dynamic filters, and custom product layouts to match your brand and sales goals.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Smart & Scalable Solutions</h6>
												<p className="fs-7 text-300 fw-regular">Combining creativity with technical precision, I deliver CMS-driven websites that are easy to manage, future-ready, and optimized for business growth.</p>
											</div>
										</div>
									</div>
